/*
** Copyright (C) 2001-2026 NETWATCH.AI SIA
**
...
Example: netwatch_agentd -c %[2]s

Report bugs to: <https://support.netwatch.ai>
Netwatch home page: <https://www.netwatch.ai>
Documentation: <https://www.netwatch.ai/documentation>
`
